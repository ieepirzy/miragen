...
- **`grok-build`** — Grok Build via MIT `grok-build-client` (`headless` or `acp` transport; image installs CLI + client). See [docs/design/kimi-and-grok-executors.md](docs/design/kimi-and-grok-executors.md) and [packages/grok-build-client](packages/grok-build-client).
