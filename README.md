...
- **`grok-build`** — Grok Build CLI headless (`grok` on PATH; published image installs it). See [docs/design/kimi-and-grok-executors.md](docs/design/kimi-and-grok-executors.md).
